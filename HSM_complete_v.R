...
list.of.packages <- c("spatialEco","rgdal", "devtools", "rJava", "raster", "rasterVis", "devtools", "ggplot2", "countrycode", "CoordinateCleaner", "rgbif", "raster", 'dismo', 'ENMeval', 'dplyr', "ecospat",
...
if(myspecies_rangemap$Range == "Yes"){
  ...
  # Box extent
  box_extent_analysis <- st_read(paste0("./Data/range_maps/ECCC_Ranges_Polygons/", chartr(" ", "_", myspecies), ".shp"))
