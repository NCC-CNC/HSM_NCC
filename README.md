...
- Predictors (rasters):
  ...
  - **Landcover**. We aggregated 32 landcover types from ESA-CCI <a href="https://www.esa-landcover-cci.org/" target="_blank"> into 13. We then reclassified these landscover types into binary presence absence rasters and used a 9x9 moving window analysis to convert them into continuous variables. 
